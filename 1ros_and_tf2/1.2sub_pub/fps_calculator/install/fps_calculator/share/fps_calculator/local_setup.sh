...
: ${AMENT_CURRENT_PREFIX:="/media/qing/NEW/RM/hotpot_exam2/1ros_and_tf2/1.2sub_pub/fps_calculator/install/fps_calculator"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/fps_calculator/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/fps_calculator/environment/path.sh"
