...
: ${AMENT_CURRENT_PREFIX:="/media/qing/NEW/RM/hotpot_exam2/1ros_and_tf2/1.5rviz2/marker/install/marker"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/marker/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/marker/environment/path.sh"
