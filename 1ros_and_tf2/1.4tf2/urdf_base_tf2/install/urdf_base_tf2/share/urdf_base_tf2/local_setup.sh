...
: ${AMENT_CURRENT_PREFIX:="/media/qing/NEW/RM/hotpot_exam2/1ros_and_tf2/1.4tf2/urdf_base_tf2/install/urdf_base_tf2"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/urdf_base_tf2/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/urdf_base_tf2/environment/path.sh"
