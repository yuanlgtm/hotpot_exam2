...
: ${AMENT_CURRENT_PREFIX:="/media/qing/NEW/RM/hotpot_exam2/1ros_and_tf2/1.3sensor_storage/rmsimulator_listener/install/rmsimulator_listener"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rmsimulator_listener/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rmsimulator_listener/environment/path.sh"
